    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <x-backend.breadcrumb data='Add Course' />
                </div>
            </div><!-- /.container-fluid -->
        </section>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}" placeholder="{{ __('Course Title') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="slug">{{ __('Slug') }}</label>
                                        <input type="text" class="form-control" name="slug" id="slug" value="{{ old('slug') }}" placeholder="{{ __('Course Slug') }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="price">{{ __('Price') }}</label>
                                        <input type="number" class="form-control" name="price" id="price" value="{{ old('price') }}" placeholder="{{ __('Course Price') }}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile">{{ __('Course Image') }}</label>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="type" id="type">
                                            ...
                                            <option value="{{ __('premium') }}">{{ __('Premium') }}</option>
                                            <option value="{{ __('free') }}">{{ __('Free') }}</option>
                                        </select>
                                    </div>
