    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">{{ __('Add New Sub Category') }}</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <!-- form start -->
            <form action="{{ route('admin.add.subcategory') }}" method="post" enctype="multipart/form-data" id="addCategoryForm">
                @csrf
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="e_slug">{{ __('Select Category') }}</label>
