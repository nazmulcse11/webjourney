<div class="modal fade" id="editSubCategoryModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- form start -->
            <form action="{{ route('admin.edit.subcategory') }}" method="post" enctype="multipart/form-data" id="addSubCategoryForm">
                @csrf
                ...
                <div class="modal-body">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="e_category_id">{{ __('Select Category') }}</label>
